...
var StateInput = React.createClass({displayName: "StateInput",
  ...
  render: function () {
    var listItems = this.props.states.map(function(state) {
      return React.createElement("option", {key: 'state-'+state.code, value: state.code}, state.name)
    });
    return (
      React.createElement("div", {className: "form-group"}, 
        React.createElement("label", {className: "col-sm-2 control-label"}, "State:"), 
        React.createElement("div", {className: "col-sm-10"}, 
          React.createElement("select", {value: this.state.value, className: "form-control", onChange: this.handleStateSelect}, 
            listItems
          )
        )
      )
...
var CountyInput = React.createClass({displayName: "CountyInput",
  render: function () {
    var listItems = this.props.counties.map(function(county) {
      return React.createElement("option", {key: 'county-'+county.countyCode, value: county.countyCode}, county.name)
    });
    return (
      React.createElement("div", {className: "form-group"}, 
        React.createElement("label", {className: "col-sm-2 control-label"}, "County:"), 
        React.createElement("div", {className: "col-sm-10"}, 
    ...
    return (
      React.createElement("div", {className: "main-page"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-xs-6 col-md-4 col-md-offset-2"}, 
            React.createElement("div", {className: "panel panel-default"}, 
              React.createElement("div", {className: "panel-heading"}, 
                React.createElement("h3", {className: "panel-title"}, "Where Are You At?")
              ), 
              React.createElement("div", {className: "panel-body"}, 
                ...
                React.createElement(CountyInput, {counties: this.state.counties})
                )
              )
            )
          ), 
          React.createElement("div", {className: "col-xs-6 col-md-4"}, 
            React.createElement("div", {className: "panel panel-default"}, 
              React.createElement("div", {className: "panel-heading"}, 
                React.createElement("h3", {className: "panel-title"}, "How Much Do You Make?")
              ), 
              React.createElement("div", {className: "panel-body"}
...
module.exports = Home;
},{"react":197}],2:[function(require,module,exports){
var React = require('react');
      ...
      React.createElement("nav", {className: "navbar navbar-inverse navbar-fixed-top"}, 
        React.createElement("div", {className: "container-fluid"}, 
          React.createElement("div", {className: "navbar-header"}, 
            ...
            React.createElement(Router.Link, {to: "home", className: "navbar-brand home"}, "ItemChimp")
          ), 
...
},{"../routes/Home":1,"react":197,"react-router":28}],3:[function(require,module,exports){
